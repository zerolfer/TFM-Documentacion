...
\begin{description}
    ...
    \item [\namedlabel{ATC (Control de Tránsito Aéreo)}] <<Término común que designa todos los servicios proporcionados para asegurar y acelerar el flujo de tráfico aéreo a través del espacio aéreo controlado>>.~\cite{ENAIRE-web}
