...
\begin{enumerate}[label={H\arabic*}]
    \item \label{H1} Es posible implementar las modificaciones y extensiones al sistema en un tiempo máximo de 7 meses, de forma que cumpla todos los requisitos del mismo y resuelva el problema dado %TODO referenciar el apartado de requisitos
