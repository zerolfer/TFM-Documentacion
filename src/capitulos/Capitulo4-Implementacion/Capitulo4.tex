...
\begin{enumerate}[label={\textbf{RIO\arabic*}}, ref={RC\arabic*},  align=left]
	...
	\begin{enumerate}[label*={\textbf{.\arabic*}}]
		\item Definición del turno. Contiene la hora de inicio y fin del turno completo asi como del tipo (mañana, tarde, noche y largo o corto).
	...
	\begin{enumerate}[label*={\textbf{.\arabic*}}]
		...
		\end{enumerate}
		\item El formato para humanos será un fichero excel (xlsx) con tres partes:
		\begin{enumerate}[label*={\textbf{.\arabic*}}]
...
\begin{itemize}
	...
	\item Microsoft Office y Umlet (diagramas)
