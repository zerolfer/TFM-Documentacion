...
%TODO Se tratan de slots inalterables en todos los casos, pero a la hora de contabilizarse el trabajo (véase Fitness) %TODO referencia no se han de computar como tiempo de descanso
