...
En nuestro caso, hemos elegido un tamaño de slot de 5 minutos debido a que se trata del máximo común divisor de todas las restricciones numéricas del dominio del problema (véase requisito). Los expertos de \gls{CRIDA} están satisfechos con este nivel de detalle. % TODO REFERENCIAS!!!)
