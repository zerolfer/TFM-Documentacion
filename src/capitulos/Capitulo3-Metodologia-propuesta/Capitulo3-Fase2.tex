...
Ésta es precisamente la técnica más usual para introducir exploración en una metaheurística. 
...
El enfoque determinista recorre la lista de entornos definida para el sistema de forma convencional, mientras que el enfoque probabilista permite equilibrar el uso de entornos de cada uno de los dos tipos seleccionando uno aleatoriamente. 
