...
%Por supuesto, cada problema es diferente y se adapta mejor a un método u otro y es por eso que con el tiempo se han definido algunas variaciones de VNS básico y que reciben nombres diferentes. El VNS en su versión básica fue propuesto en 1997 por Hansen y Mladenovi en~\cite{vns1997}, y fue ampliado con las variaciones indicadas en~\cite{vns1999,vns2003}
%
...
\NEW{El primero, \textit{Equal Weights}, se emplea en casos donde el decisor no aporte información de preferencia de objetivos. Los demás toman ese orden y nos permiten calcular el valor de cada peso mediante una fórmula diferentes para cada uno.} 
