...
\begin{algorithm}[h]
	...
	\Repeat{No queden controladores por probar}{
		Seleccionar un controlador $c_1$ aleatoriamente
		Elegir un periodo de trabajo de $c_1$ aleatoriamente 
	}
