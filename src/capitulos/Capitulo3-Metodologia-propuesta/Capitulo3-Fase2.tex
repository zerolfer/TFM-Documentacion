...
\begin{algorithm}[h]
    ...
    \If{se cumplen las restricciones del dominio (en especial que la acreditación sea válida, Requisito \ref{RD:acreditacion-valida}) y del entorno \label{line:maxcarga:restricciones}}
