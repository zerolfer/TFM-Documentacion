...
%TODO: poner cuales son los casos más dificiles (el 7 uno de ellos)!!!
...
\begin{table}[]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{cccccccccc}
			...
			\multicolumn{10}{c}{}                                                                                                                                                                                                                                                                                                                                                                                                                                                                   \\
			\multicolumn{1}{c|}{}                      & {\color[HTML]{003532} Caso 1} & {\color[HTML]{003532} 12.8183}                                       & {\color[HTML]{9A0000} \textbf{24}}                                 & {\color[HTML]{9A0000} \textbf{0.9718}}                  & {\color[HTML]{003532} 1.0000} & {\color[HTML]{003532} 0.9703} & {\color[HTML]{003532} 1.0000} & {\color[HTML]{003532} 0.6632} & {\color[HTML]{003532} 6.1894}                                        \\
...
\begin{table}[]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{cccccccccc}
			...
			\multicolumn{10}{c}{}                                                                                                                                                                                                                                                                                                                                                                                                                                                                   \\
			\multicolumn{1}{c|}{}                      & {\color[HTML]{003532} Caso 1} & {\color[HTML]{003532} 11.7111}                                       & {\color[HTML]{9A0000} \textbf{24}}                                 & {\color[HTML]{9A0000} \textbf{0.9721}}                  & {\color[HTML]{003532} 1.0000} & {\color[HTML]{003532} 0.9729} & {\color[HTML]{003532} 1.0000} & {\color[HTML]{003532} 0.6575} & {\color[HTML]{003532} 10}                                            \\
...
Para el caso 1, inicialmente tenemos un total de 24 controladores, como se puede ver en la \autoref{fig:5:solucion-inicial-caso1}, que asciende a 27 tras la \faseuno{} de inicialización: para poder codificar las condiciones del caso, se necesitan 3 adicionales, ''imaginarios". La \autoref{fig:5:solucion-fase1-caso1} muestra el resultado de la manipulación de la inicial llevada a cabo por la \faseuno{} y que será tomada como solución inicial de la \fasedos{}.

Por su parte, la \fasedos{} que emplea la metaheurística de VNS logra eliminar todos los controladores imaginarios y reducir los recursos empleados a los mismos que los iniciales. Sin embargo, el SA no lo logra, dando como resultado una solución que emplea 25 controladores. Como hemos mencionado, este valor es crítico para el sistema y por ello repercute en un gran impacto en el fitness, logrando, el VNS, un fitness total de $0.9718$ frente al $0.7117$ del SA. En la \autoref{fig:5:solucion-final-caso1} podemos ver una de las soluciones obtenidas en ambas metaheurísticas.

En el caso 7 obtenemos unas soluciones peores que en el caso anterior, algo comprensible teniendo en cuenta la dificultad del caso (véase la \autoref{sec:5:def-casos}), pero muy superiores pese a ello, a las del SA. Inicialmente el caso parte de 25 controladores, que se amplían en la \faseuno{} con cuatro imaginarios, un total de 28 que logramos reducir a 26 en su solución final. Una diferencia muy grande respecto al SA, que ni siquiera logra reducir un solo controlador. Por ello, la diferencia de valor total de la solución es muy grande: el SA obtiene una media de $0.6146$ mientras que el VNS logra la cifra de $0.9335$.

A continuación, mostraremos las soluciones obtenidas en cada fase del sistema para los dos casos mencionados anteriormente, no obstante, el resto de ellas se encuentran recopiladas en el \autoref{Anexo:recopilacion-soluciones-por-fases}.

%\subsubsection{Soluciones del Caso 1}
%
%Como se ha mencionado previamente, el problema inicial del caso parte de 24 controladores, tal y como se puede apreciar en la \autoref{fig:5:solucion-inicial-caso5}. Tras la \faseuno{}, de inicialización
%
%
%\subsubsection{Soluciones del Caso 1}
